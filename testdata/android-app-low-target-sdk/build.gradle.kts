...
private val apkSetName = "low-target-sdk"
...
// the root build automatically substitute that dependency for this included build's project.
...
android {
    ...
    defaultConfig {
        ...
        minSdk = 33
        // Deliberately below Accrescent's minimum target SDK so that parsing this app's APK set
        // fails with ApkSetParseError.RequirementError.LowTargetSdk
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
