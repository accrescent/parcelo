...
CREATE TABLE apps2 (id TEXT NOT NULL PRIMARY KEY, label TEXT NOT NULL, version_code INT NOT NULL, version_name TEXT NOT NULL, short_description TEXT NOT NULL, file_id INT NOT NULL, icon_id INT NOT NULL, review_issue_group_id INT NULL, updating BOOLEAN DEFAULT 0 NOT NULL, CONSTRAINT fk_apps_file_id__id FOREIGN KEY (file_id) REFERENCES files(id) ON UPDATE RESTRICT, CONSTRAINT fk_apps_icon_id__id FOREIGN KEY (icon_id) REFERENCES icons(id) ON UPDATE RESTRICT, CONSTRAINT fk_apps_review_issue_group_id__id FOREIGN KEY (review_issue_group_id) REFERENCES review_issue_groups(id) ON UPDATE RESTRICT);
